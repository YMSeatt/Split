...
class SeatingChartApp:
    ...
    def setup_ui(self):
        ...
        self.top_controls_frame_row2 = ScrollableToolbar(top_controls_frame_row1.interior); self.top_controls_frame_row2.pack(side=tk.LEFT, fill=tk.X, pady=(2, 5))
        ...
        self.canvas_frame = ttk.Frame(self.main_frame); self.canvas_frame.pack(fill=tk.BOTH, after=self.top_controls_frame_row1, expand=True)
